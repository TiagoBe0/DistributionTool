    ...
    children=[
        ...
        html.Div(
            ...
            style={
                ...
                "gap": "16px", "padding": "14px 24px", "fontSize": "18px", "fontWeight": "bold",
        ...
        html.Div(
            ...
            children=[
                dcc.Upload(
                    id="upload",
                    children=html.Div(
                        ["Arrastrá o ", html.A("seleccioná", style={"color": "var(--accent)", "cursor": "pointer"}),
                         " el CSV de output de distool"],
                    ),
                    style={
                        "width": "100%", "height": "52px", "lineHeight": "52px",
                        "borderWidth": "1px", "borderStyle": "dashed", "borderRadius": "6px",
                        "borderColor": "var(--border)", "textAlign": "center", "color": "var(--muted)",
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        # Info
                        html.Div(id="atom-count", style={"color": "var(--muted)", "fontSize": "12px", "lineHeight": "1.6"}),
                    ],
                ),
...
def update_plot(dist_range, defect_types, atom_types, color_col, point_size, opacity, colorscale, theme_name):
    theme = THEMES.get(theme_name, THEMES["dark"])
